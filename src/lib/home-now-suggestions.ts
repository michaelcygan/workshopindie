...
const LIVE: NowSeed[] = [
  { id: "live-today-open", lane: "live", source: "today", status: "TODAY", title: "Post what you're working on today", detail: "One line in {group} is enough.", to: "/g/$slug", params: { slug: "{groupSlug}" }, needs: ["group"], weight: 6 },
  ...
  { id: "live-late-shift", lane: "live", source: "today", status: "LATE", title: "Late shift — who else is up?", to: "/g/$slug", params: { slug: "{groupSlug}" }, needs: ["group"], hours: [22, 24], weight: 3 },
  { id: "live-city-groups", lane: "live", source: "city", status: "{city}", title: "Groups organising in {city}", to: "/groups", needs: ["city"], weight: 2 },
  { id: "live-mine-events", lane: "live", source: "event", status: "YOURS", title: "Events you said you'd go to", to: "/events", search: { mine: true }, weight: 2 },
  { id: "live-irl", lane: "live", source: "event", status: "IN PERSON", title: "Something to leave the house for", to: "/events", search: { format: "in_person" }, weight: 2 },
];

/* ─────────────────────────── MAKE lane ─────────────────────────── */

const MAKE: NowSeed[] = [
  { id: "make-publish-work", lane: "make", source: "continue", status: "PUBLISH", title: "Publish something you've been sitting on", detail: "It doesn't have to be finished.", to: "/works/new", weight: 6 },
  { id: "make-publish-medium", lane: "make", source: "medium", status: "{medium}", title: "Post a new piece of {medium}", to: "/works/new", needs: ["medium"], weight: 5 },
  { id: "make-publish-group", lane: "make", source: "group", status: "{group}", title: "Share your latest work with {group}", to: "/works/new", search: { group: "{groupSlug}" }, needs: ["group"], weight: 4 },
  { id: "make-process-note", lane: "make", source: "evergreen", status: "WRITE", title: "Write the process note nobody asked for", detail: "How you actually made the thing.", action: { kind: "blog-prompt", seedPromptId: "process-note" }, weight: 5 },
  { id: "make-what-changed", lane: "make", source: "evergreen", status: "WRITE", title: "What changed in your work this year", action: { kind: "blog-prompt", seedPromptId: "what-changed" }, weight: 4 },
  { id: "make-five-things", lane: "make", source: "evergreen", status: "WRITE", title: "Five things you're stealing from right now", action: { kind: "blog-prompt", seedPromptId: "five-influences" }, weight: 4 },
  { id: "make-tools", lane: "make", source: "evergreen", status: "WRITE", title: "The tools you actually use", detail: "Not the ones you meant to use.", action: { kind: "blog-prompt", seedPromptId: "tools" }, weight: 3 },
  { id: "make-failed", lane: "make", source: "evergreen", status: "WRITE", title: "A project that failed, and what it taught you", action: { kind: "blog-prompt", seedPromptId: "failed-project" }, weight: 3 },
  { id: "make-city-scene", lane: "make", source: "city", status: "WRITE", title: "Write about the scene in {city}", action: { kind: "blog-prompt", seedPromptId: "city-scene" }, needs: ["city"], weight: 4 },
  { id: "make-medium-essay", lane: "make", source: "medium", status: "WRITE", title: "Say something honest about {medium}", action: { kind: "blog-prompt", seedPromptId: "medium-essay" }, needs: ["medium"], weight: 4 },
  { id: "make-work-story", lane: "make", source: "continue", status: "WRITE", title: "Tell the story behind \u201c{work}\u201d", action: { kind: "blog-prompt", seedPromptId: "work-story" }, needs: ["work"], weight: 5 },
  { id: "make-collab-open", lane: "make", source: "evergreen", status: "COLLAB", title: "Open a call for collaborators", to: "/collab/new", weight: 5 },
  { id: "make-collab-weekend-film", lane: "make", source: "evergreen", status: "COLLAB", title: "Weekend short film — find a crew", action: { kind: "collab-prompt", prompt: "weekend-short-film" }, days: [3, 4, 5], weight: 4 },
  { id: "make-collab-remix", lane: "make", source: "evergreen", status: "COLLAB", title: "One-night remix swap", action: { kind: "collab-prompt", prompt: "one-night-remix" }, weight: 3 },
  { id: "make-collab-feedback", lane: "make", source: "evergreen", status: "COLLAB", title: "Portfolio feedback swap", detail: "You read theirs, they read yours.", action: { kind: "collab-prompt", prompt: "portfolio-feedback-swap" }, weight: 4 },
  ...
  { id: "make-archive", lane: "make", source: "evergreen", status: "ARCHIVE", title: "Dig out something from two years ago", to: "/works/new", weight: 2 },
  { id: "make-series", lane: "make", source: "medium", status: "SERIES", title: "Turn your {medium} into a series", to: "/works/new", needs: ["medium"], weight: 3 },
  { id: "make-constraint", lane: "make", source: "evergreen", status: "EXERCISE", title: "Make something using only one constraint", detail: "One colour, one take, one instrument.", to: "/works/new", weight: 3 },
  { id: "make-collab-group", lane: "make", source: "group", status: "COLLAB", title: "Start a project with {group}", to: "/collab/new", search: { group: "{groupSlug}" }, needs: ["group"], weight: 4 },
  { id: "make-morning-page", lane: "make", source: "evergreen", status: "MORNING", title: "Write 300 words before anything else", action: { kind: "blog-prompt", seedPromptId: "morning-pages" }, hours: [5, 11], weight: 3 },
  { id: "make-sunday-reset", lane: "make", source: "evergreen", status: "SUNDAY", title: "Plan the week's one real project", action: { kind: "blog-prompt", seedPromptId: "week-plan" }, days: [0], weight: 4 },
  { id: "make-teach", lane: "make", source: "medium", status: "TEACH", title: "Teach one {medium} technique in 400 words", action: { kind: "blog-prompt", seedPromptId: "teach-technique" }, needs: ["medium"], weight: 3 },
  { id: "make-interview", lane: "make", source: "evergreen", status: "WRITE", title: "Interview someone whose work you like", action: { kind: "blog-prompt", seedPromptId: "interview" }, weight: 3 },
  { id: "make-review", lane: "make", source: "city", status: "WRITE", title: "Review a show you saw in {city}", action: { kind: "blog-prompt", seedPromptId: "review" }, needs: ["city"], weight: 3 },
  { id: "make-manifesto", lane: "make", source: "evergreen", status: "WRITE", title: "Write the manifesto for your practice", action: { kind: "blog-prompt", seedPromptId: "manifesto" }, weight: 2 },
  { id: "make-day-in-life", lane: "make", source: "evergreen", status: "WRITE", title: "A day in your working life, hour by hour", action: { kind: "blog-prompt", seedPromptId: "day-in-life" }, weight: 2 },
  { id: "make-money", lane: "make", source: "evergreen", status: "WRITE", title: "How you actually pay for the work", action: { kind: "blog-prompt", seedPromptId: "money" }, weight: 2 },
  { id: "make-collab-browse", lane: "make", source: "evergreen", status: "JOIN", title: "Answer someone else's open call", to: "/collab", weight: 4 },
  { id: "make-collab-medium", lane: "make", source: "medium", status: "{medium}", title: "Open calls looking for {medium}", to: "/collab", needs: ["medium"], weight: 4 },
  { id: "make-collab-city", lane: "make", source: "city", status: "{city}", title: "Collaborators in {city}", to: "/collab", needs: ["city"], weight: 4 },
  { id: "make-collab-online", lane: "make", source: "evergreen", status: "REMOTE", title: "Remote-friendly collaborations", to: "/collab", search: { online: true }, weight: 2 },
  { id: "make-finish", lane: "make", source: "continue", status: "FINISH", title: "Finish \u201c{work}\u201d instead of starting something new", needs: ["work"], to: "/works/$slug", params: { slug: "{workSlug}" }, weight: 4 },
  { id: "make-caption", lane: "make", source: "continue", status: "EDIT", title: "Give \u201c{work}\u201d the description it deserves", needs: ["work"], to: "/works/$slug/edit", params: { slug: "{workSlug}" }, weight: 3 },
  { id: "make-night-session", lane: "make", source: "evergreen", status: "NIGHT", title: "One quiet hour on the thing you keep avoiding", to: "/works/new", hours: [21, 24], weight: 3 },
  { id: "make-sketch", lane: "make", source: "evergreen", status: "SKETCH", title: "Post a sketch, not a finished piece", to: "/works/new", weight: 3 },
  { id: "make-remake", lane: "make", source: "evergreen", status: "EXERCISE", title: "Remake something you love, badly, on purpose", to: "/works/new", weight: 2 },
  { id: "make-collab-mentor", lane: "make", source: "evergreen", status: "COLLAB", title: "Offer an hour of your expertise", to: "/collab/new", weight: 3 },
  { id: "make-group-today", lane: "make", source: "group", status: "{group}", title: "Answer today's thread in {group}", to: "/g/$slug", params: { slug: "{groupSlug}" }, needs: ["group"], weight: 4 },
];
...
const EXPLORE: NowSeed[] = [
  ...
  { id: "exp-blog-members", lane: "explore", source: "evergreen", status: "READ", title: "What members are writing", to: "/blog", weight: 4 },
  { id: "exp-groups-browse", lane: "explore", source: "group", status: "GROUPS", title: "Find your people", to: "/groups", weight: 4 },
  { id: "exp-groups-city", lane: "explore", source: "city", status: "{city}", title: "Groups based in {city}", to: "/groups", needs: ["city"], weight: 4 },
  { id: "exp-cities", lane: "explore", source: "city", status: "CITIES", title: "See what other cities are building", to: "/cities", weight: 3 },
  { id: "exp-events", lane: "explore", source: "event", status: "EVENTS", title: "Everything coming up", to: "/events", weight: 4 },
  { id: "exp-collabs", lane: "explore", source: "evergreen", status: "OPEN CALLS", title: "Who needs help right now", to: "/collab", weight: 4 },
  ...
  { id: "exp-refer", lane: "explore", source: "network", status: "INVITE", title: "Bring someone whose work deserves an audience", to: "/refer", weight: 2 },
  ...
  { id: "exp-groups-new", lane: "explore", source: "group", status: "NEW", title: "Groups that just opened up", to: "/groups", weight: 2 },
  { id: "exp-workshops-join", lane: "explore", source: "evergreen", status: "LEARN", title: "Learn something from another maker", to: "/workshops", weight: 2 },
  { id: "exp-events-online", lane: "explore", source: "event", status: "ONLINE", title: "Join from wherever you are", to: "/events", search: { format: "online" }, weight: 2 },
  { id: "exp-tickets", lane: "explore", source: "continue", status: "TICKETS", title: "Your tickets and RSVPs", to: "/me/tickets", weight: 1 },
  { id: "exp-gallery-medium-deep", lane: "explore", source: "medium", status: "{medium}", title: "Go deep on {medium} today", to: "/gallery", needs: ["medium"], weight: 3 },
  { id: "exp-neighbours", lane: "explore", source: "city", status: "NEARBY", title: "Makers near you in {city}", to: "/cities/$slug", params: { slug: "{citySlug}" }, needs: ["city"], weight: 3 },
  { id: "exp-blog-city", lane: "explore", source: "city", status: "READ", title: "Stories out of {city}", to: "/blog", needs: ["city"], weight: 3 },
];
