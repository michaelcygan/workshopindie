...
/**
 * Horizontal rail of active Lounges inside Groups the viewer has joined.
 * Group Lounges were previously invisible from /lounge discovery.
 */
        ...
        {lounges.map((l) => (
          ...
          >
            ...
            <p className="mt-0.5 truncate font-display text-sm text-ink">
              {formatRoomTitle(l.title, l.medium) || "Lounge"}
            </p>
