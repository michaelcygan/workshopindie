...
/**
 * PublicHome — the logged-out surface. Keeps the full globe hero and the
 * explanatory editorial structure. The only structural change from the legacy
 * homepage is that "Stories around the Work" sits high, right under the globe,
 * so visitors immediately see how Workshop's primitives intersect.
 */
export function PublicHome() {
  return (
    <main>
      ...
      {/* ─── Connected context, high on the page ─── */}
