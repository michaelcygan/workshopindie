  ...
  return (
    <>
      ...
      <div className={cn("mt-4 grid gap-4", contentFocus ? "md:grid-cols-[1fr]" : "md:grid-cols-[1fr_260px]", isMobile && "hidden")}>
        <div className="relative flex flex-col rounded-xl border border-border bg-surface shadow-soft overflow-hidden">
          {pinned && (
          ...
          {viewMode === "tools" ? (
            <div className="h-[clamp(320px,44vh,520px)] xl:h-[58vh] overflow-y-auto p-3 md:p-4">
            ...
            <div className="h-[clamp(320px,44vh,520px)] xl:h-[58vh] p-3 md:p-4">
              {fsView === "gallery" ? (
            ...
            <>
              ...
              <div className="relative flex h-[clamp(320px,44vh,520px)] xl:h-[58vh] flex-col">
              {roomId && (
