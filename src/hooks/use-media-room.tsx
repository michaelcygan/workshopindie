...
export function useMediaRoom(roomId: string | undefined) {
  ...
  function createPeer(
    ...
    const meta: PeerMeta = {
      ...
      videoOffStreak: 0,
      recoverStreak: 0,
      videoOffSuspended: false,
      reconnectCount: 0,
      iceRestarts: 0,
      snapSampleCount: 0,
      snapLastBytesOutVideo: 0,
      snapLastBytesOutAudio: 0,
      snapLastBytesInVideo: 0,
      snapLastBytesInAudio: 0,
      snapLastPacketsOut: 0,
      snapLastRetransOut: 0,
      snapLastPacketsInLost: 0,
      snapLastPacketsInRecv: 0,
      snapAccRttMs: 0,
      snapAccKbpsOutV: 0,
      snapAccKbpsOutA: 0,
      snapAccKbpsInV: 0,
