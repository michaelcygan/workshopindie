...
export const Route = createFileRoute("/w/$token")({
  ...
  head: ({ loaderData }) => {
    ...
    const desc = link?.prompt ?? "Drop into live Group audio.";
    const meta: any[] = [
      { title },
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="space-y-4 p-6">
          ...
          <div className="flex justify-center pt-2">
            ...
            >
              ...
              {user ? (joining ? "Joining…" : "Join Group audio") : "Create free account & join"}
            </Button>
          </div>
        </div>
      </div>
      ...
      <SignupGateModal
        ...
        subtitle="Create a free account to drop into the Group audio. It's quick."
        onAuthed={() => {
          setGateOpen(false);
