...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Workshop — Find people. Make the thing. Show the Work." },
      { name: "description", content: "Schedule time-boxed creative Workshops, meet collaborators, and build a portfolio from what you ship." },
      { property: "og:title", content: "Workshop" },
      { property: "og:description", content: "Find people. Make the thing. Show the Work." },
