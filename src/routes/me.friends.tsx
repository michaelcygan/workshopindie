...
export const Route = createFileRoute("/me/friends")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mutual follows, online status, and one-tap invites to Group audio." },
    ...
    return (
      <main className="mx-auto max-w-2xl px-4 py-10">
        ...
        <p className="mt-2 text-sm text-ink-muted">
          Sign in to see your mutual follows and invite them into live audio.
        </p>
        <Link to="/login" className="mt-4 inline-flex rounded-full bg-primary px-5 py-2 text-sm font-medium text-primary-foreground">
          Sign in
        </Link>
      </main>
    );
