...
GROUPS.update({
    ...
    "indie-filmmakers": ['16mm film reel spools', 'film editing splicer bench', 'cinema camera equipment tripod set', 'clapperboard film set'],
...
CATS.update({
    ...
    "indie-filmmakers": ["Movie cameras", "16 mm film", "Film reels", "Clapperboards", "Film editing equipment"],
